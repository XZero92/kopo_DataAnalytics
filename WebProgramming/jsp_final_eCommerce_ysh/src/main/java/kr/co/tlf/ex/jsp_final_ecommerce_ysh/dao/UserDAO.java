...
public boolean insertUser(UserDTO user) {
    ...
    public boolean updateUser(String userId, String userName, String password, String mobileNo) {
    ...
    // 회원 권한 변경
    public boolean updateUserType(String userId, String userType) {
    ...
    public List<UserDTO> getUsers(int currentPage, int recordsPerPage, String searchType, String searchKeyword) {
    ...
    // ResultSet에서 UserDTO 객체 추출 유틸리티 메서드
    ...
    public int countUsers(String searchType, String searchKeyword) {
    ...
    /*public boolean updateEncryptedPasswordsForAdmin() {
        String selectQuery = "SELECT ID_USER, NM_PASWD FROM TB_USER WHERE NM_ENC_PASWD IS NULL";
        String updateQuery = "UPDATE TB_USER SET NM_ENC_PASWD = ? WHERE ID_USER = ?";
        try (Connection conn = dataSource.getConnection();
            ...
            while (rs.next()) {
                ...
                String plainPassword = rs.getString("NM_PASWD");
