...
public class UserDTO {
    ...
    // 모든 필드를 포함한 생성자
    public UserDTO(String userId, String userName, String password, String email, String mobileNo, String status, String userType, String registerNo, Timestamp firstDate) {
        this.userId = userId;
